 ...
 */
public class MyLastShowAdapter extends BaseAdapter {
    private Context context;
    private List<HomeRoot.DataEntity.DefaultGoodsListEntity> list;

    public MyLastShowAdapter(Context context, List<HomeRoot.DataEntity.DefaultGoodsListEntity> list) {
